...
# Clone Linux kernel v6.18
echo "Cloning Linux kernel v6.18..."
git clone --depth 1 --branch v6.18 https://git.kernel.org/pub/scm/linux/kernel/git/torvalds/linux.git /home/ktest/git/linux
