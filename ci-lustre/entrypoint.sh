...
# Clone Linux kernel v6.16
echo "Cloning Linux kernel v6.16..."
git clone --depth 1 --branch v6.16 https://git.kernel.org/pub/scm/linux/kernel/git/torvalds/linux.git /home/ktest/git/linux
