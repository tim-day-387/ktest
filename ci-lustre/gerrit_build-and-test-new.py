...
TESTS = [
    ...
    {
        "Command": "./podman-ktest run_immutable -w /home/ktest/git/lustre-release /home/ktest/ktest/tools/git-contrib-with-rev.sh",
    ...
    {
        "Command": "./podman-ktest run ./qlkbuild build --purge-ktest-out 1 --clean-git 1 --allow-warnings 1 --build-lustre 0",
        "Title": "Kernel Build",
    ...
    {
        "Command": "./podman-ktest run ./qlkbuild build --purge-ktest-out 0 --clean-git 1 --allow-warnings 1 --build-lustre 1",
        "Title": "Lustre Build",
    ...
    {
        "Command": "./podman-ktest run_immutable ./qlkbuild run --purge-ktest-out 0 --clean-git 0 --allow-warnings 1 --build-lustre 0 --build-kernel 0 ./tests/fs/lustre/sanity-quick.ktest",
