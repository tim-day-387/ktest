...
TESTS = [
    {
        "Command": "cd /home/timothy/git/lustre-release ; ~/ws/ktest/tools/checkpatch-parallel",
    ...
    {
        "Command": "cd /home/timothy/ws/ktest ; ./qlkbuild build --purge-ktest-out 1 --clean-git 1 --allow-warnings 1 --build-lustre 1",
        "Title": "Build In-Tree Lustre",
        "Description": "Build Lustre natively in the Linux tree using copy-builtin",
        "Enforced": True,
        "Type": TestType.IN_TREE_BUILD,
    },
    {
        "Command": "cd /home/timothy/ws/ktest ; ./qlkbuild run --purge-ktest-out 0 --clean-git 0 --allow-warnings 1 --build-lustre 0 --build-kernel 0 ./tests/fs/lustre/boot.ktest",
        "Title": "boot.ktest",
    ...
    {
        "Command": "cd /home/timothy/ws/ktest ; ./qlkbuild run --purge-ktest-out 0 --clean-git 0 --allow-warnings 1 --build-lustre 0 --build-kernel 0 ./tests/fs/lustre/llmount.ktest",
        "Title": "llmount.ktest",
    ...
    {
        "Command": "cd /home/timothy/ws/ktest ; ./qlkbuild run --purge-ktest-out 0 --clean-git 0 --allow-warnings 1 --build-lustre 0 --build-kernel 0 ./tests/fs/lustre/llog-unit.ktest",
    ...
    {
        "Command": "cd /home/timothy/ws/ktest ; ./qlkbuild run --purge-ktest-out 0 --clean-git 0 --allow-warnings 1 --build-lustre 0 --build-kernel 0 ./tests/fs/lustre/mgs-setup.ktest",
    ...
    {
        "Command": "cd /home/timothy/ws/ktest ; ./qlkbuild run --purge-ktest-out 0 --clean-git 0 --allow-warnings 1 --build-lustre 0 --build-kernel 0 ./tests/fs/lustre/sanity-quick.ktest",
        "Title": "sanity-quick.ktest",
        "Description": "Run a few sanity.sh tests",
        "Enforced": True,
        "Type": TestType.VM,
    },
]
